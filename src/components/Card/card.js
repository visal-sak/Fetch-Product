...
export default function Card({title,category,image,id,price}) {
  return (
   <>
    <div class="container">
      <div class="max-w-md w-96 bg-gray-900 shadow-lg rounded-xl p-6 m-10">
       ...
       <Link href={`/product/${id}`}> 
           <div class="relative h-62 w-full mb-3">
              ...
              <img src={image[0]} alt="Just a flower" class=" w-full   object-fill  rounded-2xl"/>
            </div>
       </Link>
            <div class="flex-auto justify-evenly">
              <div class="flex flex-wrap ">
                ...
                <div class="flex items-center w-full justify-between min-w-0 ">
                  ...
                  <div class="flex items-center bg-green-400 text-gray-50 text-xs px-2 py-1 ml-3 rounded-md">
                    INSTOCK</div>
                </div>
              </div>
